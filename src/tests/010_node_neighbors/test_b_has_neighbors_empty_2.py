...
def test_b_has_neighbors_empty_2():
    # Load base.json
    ...
    empty_neighbors = obj_manager.find_all_empty_neighbors(node_b)
    assert len(empty_neighbors) == 2, f"Node 'b' should have 2 empty neighbors, but has {len(empty_neighbors)}"
